...
public class DataManagerT : IDisposable
{
    ...
    private static DataManagerT instance;
    public DataManagerT()
    {
        dbConnection = new SqlConnection();
        var string_conexion = "Data Source=.\\SQLEXPRESS;Initial Catalog=BugTrackerGrupo9;Integrated Security=True";
